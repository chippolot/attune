...
from template import template_apply
...
def patch_setup_block(file_to_patch, setup_block_file):
    ...
    # Load block
    with open(setup_block_file, 'r') as file:
...
def sync(args):
    ...
    patch_setup_block(os.path.expanduser('~/.bash_profile'), get_repo_file_path('dotfiles/setup/.bash_profile', validate=True))
    patch_setup_block(os.path.expanduser('~/.gitconfig'), get_repo_file_path('dotfiles/setup/.gitconfig', validate=True))

    # Copy dotfiles to config folder
    print("\nCopying dotfiles...")
    copy_template(get_repo_file_path('dotfiles/.bash_profile', validate=True), get_attune_file_path('.bash_profile'))
    copy_template(get_repo_file_path('dotfiles/.gitconfig', validate=True), get_attune_file_path('.gitconfig'))
